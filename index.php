				...
				<div class="row align-items-center justify-content-between d-flex">
			      ...
			      <nav id="nav-menu-container">
			        <ul class="nav-menu">
			          ...
			          <li><a href="?histori">Histori Pesanan</a></li>      		          
			          <li><a href="contact.html">Contact</a></li>
			          <li><a href="?login">Login Member</a></li>
			          <li><a href="?daftar">Daftar Member</a></li>
			        </ul>
				...
				<div class="row fullscreen align-items-center justify-content-between">
					...
					<div class="col-lg-4 col-md-6 banner-right">
						<ul class="nav nav-tabs" id="myTab" role="tablist">
						  <li class="nav-item">
						    <a class="nav-link active" id="flight-tab" data-toggle="tab" href="#flight" role="tab" aria-controls="flight" aria-selected="true">Pesan Tiket</a>
						  </li>
						  <li class="nav-item">
						    <a class="nav-link" id="hotel-tab" data-toggle="tab" href="#hotel" role="tab" aria-controls="hotel" aria-selected="false">Cek Status</a>
						  </li>
						  <li class="nav-item">
						    <a class="nav-link" id="holiday-tab" data-toggle="tab" href="#holiday" role="tab" aria-controls="holiday" aria-selected="false">Carter Bus</a>
						  </li>
						</ul>
						<div class="tab-content" id="myTabContent">
						  <div class="tab-pane fade show active" id="flight" role="tabpanel" aria-labelledby="flight-tab">
							<form class="form-wrap">
								...
								<input type="number" min="1" max="20" class="form-control" name="adults" placeholder="Agen Keberangkatan " onfocus="this.placeholder = ''" onblur="this.placeholder = 'Adults '">
								<input type="number" min="1" max="20" class="form-control" name="Child" placeholder="Agen Tujuan " onfocus="this.placeholder = ''" onblur="this.placeholder = 'Child '">							
								<a href="#" class="primary-btn text-uppercase">Pesan Tiket</a>									
							</form>
						  </div>
						  <div class="tab-pane fade" id="hotel" role="tabpanel" aria-labelledby="hotel-tab">
							<form class="form-wrap">
								<input type="text" class="form-control" name="name" placeholder="Masukan Kode Booking " onfocus="this.placeholder = ''" onblur="this.placeholder = 'Masukan Kode Boking'">		
								<input type="text" class="form-control date-picker" name="start" placeholder="Pilih Tanggal " onfocus="this.placeholder = ''" onblur="this.placeholder = 'Start '">						
								<a href="#" class="primary-btn text-uppercase">Search Status</a>									
							</form>							  	
						  </div>
						  <div class="tab-pane fade" id="holiday" role="tabpanel" aria-labelledby="holiday-tab">
							<form class="form-wrap">
								<input type="text" class="form-control" name="name" placeholder="Masukan Nama Lengkap " onfocus="this.placeholder = ''" onblur="this.placeholder = 'From '">									
								<input type="text" class="form-control" name="to" placeholder="Masukan Email " onfocus="this.placeholder = ''" onblur="this.placeholder = 'To '">
								<input type="text" class="form-control date-picker" name="start" placeholder="Masukan Nomer Telepon " onfocus="this.placeholder = ''" onblur="this.placeholder = 'Start '">
								<input type="text" class="form-control date-picker" name="return" placeholder="Return " onfocus="this.placeholder = ''" onblur="this.placeholder = 'Return '">
								<input type="number" min="1" max="20" class="form-control" name="adults" placeholder="SHD " onfocus="this.placeholder = ''" onblur="this.placeholder = 'Adults '">			
								<a href="#" class="primary-btn text-uppercase">Carter Bus</a>									
							</form>							  	
						  </div>
						</div>
					</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
		...
		<script src="assets/js2/vendor/jquery-2.2.4.min.js"></script>
		...
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>		
			...
			<script src="assets/js2/easing.min.js"></script>			
		<script src="assets/js2/hoverIntent.js"></script>
		<script src="assets/js2/superfish.min.js"></script>	
